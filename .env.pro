...
DATABASE_URL=jdbc:postgresql://ep-restless-poetry-a4ordzt6-pooler.us-east-1.aws.neon.tech/neondb?user=neondb_owner&password=npg_MkLxyj7DT5cp&sslmode=require&channelBinding=require
